...
const AddBOInventory = lazy(() =>
    import(
        "./pages/Inventory/Type/BranchOffice/Add/BOInventoryGeneralForm"
    ).then((module) => ({
                    ...
                    <Routes>
                        ...
                        <Route element={<ProtectedRoute isLogged={isLogged} />}>
                            ...
                            <Route element={<LayoutOperation />}>
                                ...
                                <Route
                                    path="/inventory/add"
                                    element={<AddMainInventory />}
                                />
                                <Route
                                    path="/BOinventory/add"
                                    element={<AddBOInventory />}
                                />
                                <Route
                                    path="/inventory/:id"
                                ...
                                <Route
                                    ...
                                    element={
                                        <ListMainIncomeInventoryProductDetails />
                                    }
                                />
                                <Route
                                    path="/inventory/outcome/:id"
                                    element={
                                        <ListMainOutcomeInventoryProductDetails />
                                    }
                                />
                                <Route
                        ...
                        <Route
                            path="*"
                            element={<NotFound isLogged={isLogged} />}
                        />
                    </Routes>
                </SectionProvider>
            </Suspense>
